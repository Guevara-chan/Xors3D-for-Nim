; *-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-*
; Xors3D shading sample: 'Bump Specular'
...
;====================================
; Shader
Define tShader=xLoadFXFile("Media\Materials\Bump Specular.fx")
;====================================
...
Define tTextureSpecular=xLoadTexture("Media\Extra media\Rockwall_Specular.png")
Define tTextureNormal=xLoadTexture("Media\Extra media\Media\Rockwall_Normal.png")
